...
function searchCompanyNote() {
    var title = $('#search_company_note_title').val();
    var content = $('#search_company_note_content').val();
    var conpanyId = $('#search_company_note_companyId').val();
...
function clearSearch() {
    $('#search_company_note_title').val('');
    $('#search_company_note_content').val('');
    $('#search_company_note_companyId').val('');
...
$(document).ready(function() {
    ...
    table = loadTabelWithCustomerSearcher('companyNote/findPage', columns, 'companyNote/addPage', '新增资料');
    init();
});